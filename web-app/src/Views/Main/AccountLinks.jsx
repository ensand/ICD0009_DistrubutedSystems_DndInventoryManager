...
function AccountLinks(props) {
    ...
    const userFirstName = useStoreState(state => state.appState.userFirstName);
    ...
    return (
        ...
        <ul className="navbar-nav">
            ...
            <Link className="nav-link text-dark" to="/AccountDetails">Hello there, {userFirstName}</Link>
            </li>
            <li className="nav-item">
