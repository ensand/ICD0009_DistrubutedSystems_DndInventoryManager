...
namespace Extensions
{
    public static class IdentityExtensions
    {
        ...
        {
            var stringId = user.Claims.Single(c => c.Type == ClaimTypes.NameIdentifier).Value;
            ...
            {
                throw new Exception("Invalid type provided: " + typeof(TKey));
            }
        }
        ...
        public static string GenerateJwt(IEnumerable<Claim> claims, string signingKey, string issuer, int expiresInDays)
        {
            ...
            var token = new JwtSecurityToken(issuer, issuer, claims, null, expires, signinCredentials);
