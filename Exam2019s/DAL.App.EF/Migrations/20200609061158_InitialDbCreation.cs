        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedAnswer = table.Column<string>(maxLength: 1024, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MultipleChoiceQuestion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MultipleChoiceQuestion_Quizzes_QuizId",
                        column: x => x.QuizId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TextEntryQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TextEntryQuestions_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswerValue = table.Column<string>(maxLength: 1024, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answer_MultipleChoiceQuestion_MultipleChoiceQuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "TextEntryQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateIndex(
                name: "IX_Answer_MultipleChoiceQuestionId",
                table: "Answer",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "TextEntryAnswers",
                column: "TextEntryQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_TextEntryQuestions_QuizId",
                table: "TextEntryQuestions",
                column: "QuizId");
        }
